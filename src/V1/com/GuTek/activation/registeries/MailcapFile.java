...
public class MailcapFile
{
    ...
    public String[] getNativeCommands(final String mime_type) {
        String[] cmds = null;
        final List v = this.native_commands.get(mime_type.toLowerCase());
        if (v != null) {
    ...
    protected void parseLine(final String mailcapEntry) throws MailcapParseException, IOException {
        ...
        final String primaryType = tokenizer.getCurrentTokenValue().toLowerCase();
        String subType = "*";
        ...
        if (currentToken == 59) {
            ...
            do {
                ...
                final String paramName = tokenizer.getCurrentTokenValue().toLowerCase();
                currentToken = tokenizer.nextToken();
